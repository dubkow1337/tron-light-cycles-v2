...
| **`css/`** | Стили |
| ↳ `style.css` | Все стили и неоновое оформление |
| **`js/`** | Логика игры |
| ↳ `utils.js` | Вспомогательные функции |
| ↳ `player.js` | Логика игроков |
| ↳ `sounds.js` | Звуки и музыка |
| ↳ `bonuses.js` | Все бонусы (скорость, щит, клон, взрыв) |
| ↳ `ai.js` | Искусственный интеллект |
| ↳ `boss.js` | Босс для режима выживания |
| ↳ `survival.js` | Режим выживания (волны врагов) |
| ↳ `render.js` | Отрисовка игры на Canvas |
| ↳ `ui.js` | Интерфейс и меню |
| ↳ `game.js` | Основная игровая логика |
| ↳ `main.js` | Точка входа |
| **`assets/`** | Ресурсы |
| ↳ `images/` | Изображения и фон |
